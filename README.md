# Simple Blog Website. User can add posts which will dynamically appear on a home page, but will be limited with 100 characters. But there are the way to read each post in separate page.
